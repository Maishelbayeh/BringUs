  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === 'image' && image && image.startsWith('data:')) {
        ...
        // Upload to backend
        //https://bringus-backend.onrender.com/advertisements/upload-image
        const uploadRes = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'https://bringus-backend.onrender.com/'}advertisements/upload-image`, {
          method: 'POST',
          body: formData,
          headers: {
