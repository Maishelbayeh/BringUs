  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (mode === 'image' && image && image.startsWith('data:')) {
        ...
        // Upload to backend
        //https://https://bringus-backend.onrender.com/api/advertisements/upload-image
        const uploadRes = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'https://https://bringus-backend.onrender.com/api/'}advertisements/upload-image`, {
          method: 'POST',
          body: formData,
          headers: {
