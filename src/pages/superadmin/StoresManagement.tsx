    ...
    <div className="min-h-screen p-4 bg-gray-50">
      <div className={`${isRTL ? 'rtl' : 'ltr'}`}>
        ...
        {showExtendModal && selectedStore && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" dir={isRTL ? 'rtl' : 'ltr'}>
            <div className={`bg-white rounded-lg p-6 w-full max-w-md mx-4 ${isRTL ?'flex-row'  : 'flex-row-reverse'}`}>
              <div className={`flex items-center justify-between mb-4 ${isRTL ? 'flex-row-reverse' : 'flex-row'}`} dir={isRTL ? 'rtl' : 'ltr'}>
              ...
              <div className="space-y-4" dir={isRTL ? 'rtl' : 'ltr'}>
                ...
                <div>
                  <label className={`block text-sm font-medium text-gray-700 mb-1 ${isRTL ? 'text-right' : 'text-left'}`} dir={isRTL ? 'rtl' : 'ltr'}>
              ...
              <div className="flex gap-3 mt-6" dir={isRTL ? 'rtl' : 'ltr'}>
                <button
                  onClick={handleCloseExtendModal}
           ...
           <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
             <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
               ...
               <div className="space-y-4" dir={isRTL ? 'rtl' : 'ltr'}>
                 ...
                 <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3" dir={isRTL ? 'rtl' : 'ltr'}>
                   <div className="flex items-center gap-2">
