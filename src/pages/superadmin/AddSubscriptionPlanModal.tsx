  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (isEdit && plan) {
        ...
        response = await axios.put(`https://bringus-backend.onrender.com/subscription-plans/${plan._id}`, formData, {
          headers: {
        ...
        // Create new plan
        response = await axios.post('https://bringus-backend.onrender.com/subscription-plans', formData, {
          headers: {
            'Authorization': `Bearer ${localStorage.getItem('token')}`
          }
        });
