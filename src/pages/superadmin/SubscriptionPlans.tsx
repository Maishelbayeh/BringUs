...
const SubscriptionPlans: React.FC = () => {
  ...
  const togglePlanStatus = async (planId: string) => {
    ...
    try {
      await axios.post(`https://bringus-backend.onrender.com/subscription-plans/${planId}/toggle`, {}, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const togglePlanPopular = async (planId: string , isPopular: boolean) => {
    ...
    try {
      await axios.post(`https://bringus-backend.onrender.com/subscription-plans/${planId}/popular`, body, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const deletePlan = async (planId: string) => {
    setActionLoading(planId);
    try {
      await axios.delete(`https://bringus-backend.onrender.com/subscription-plans/${planId}`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
