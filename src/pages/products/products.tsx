...
const initialProducts: any[] = [
  ...
  { id: 2, nameEn: 'MacBook Pro',nameAr:'ماك بوك برو', categoryId: 1, subcategoryId: 2, image: 'https://images.unsplash.com/photo-1517336714731-489689fd1ca8?auto=format&fit=crop&w=400&q=80', descriptionEn: 'Apple laptop',descriptionAr:'اااااااا الاتالاتلا لاتلاتلات الالاتاخر اصدار ابل', visibility: 'N', productLabel: 3, productOrder: 2, colors: [['#808080'], ['#C0C0C0', '#4682B4']], price: 2000, availableQuantity: 100},
...
const ProductsPage: React.FC = () => {
  ...
  return (
    <div className="p-4 w-full" >
      ...
      />
      <div className="bg-white rounded-2xl p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 md:grid-cols-3 gap-6">
