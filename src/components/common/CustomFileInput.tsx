...
const CustomFileInput: React.FC<CustomFileInputProps> = ({ label, value, onChange, error, placeholder, id, style, labelAlign }) => {
  ...
  return (
    <div className="mb-4 w-full">
      ...
      >
        ...
        />
        {preview ? (
          <img src={preview} alt="preview" className="mb-2 rounded-lg object-cover text-center" style={{ width: 80, height: 80 }} />
        ) : (
        ...
        <span className={`block text-gray-500 dark:text-gray-400 font-medium text-center w-full`} >
          {value || placeholder}
        </span>
