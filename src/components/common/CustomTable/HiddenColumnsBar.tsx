      ...
      <div className="flex flex-wrap gap-2">
        {hiddenColumns.map(column => (
          <button
            ...
            className="inline-flex items-center gap-1 px-3 py-1 bg-white border border-gray-300 rounded-full text-sm text-gray-700 hover:bg-gray-50 hover:border-primary transition-colors"
